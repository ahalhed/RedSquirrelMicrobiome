...
## Core vs Rare
As defined by Mahnic and Rupnik (2018), the core microbiome includes OTUs with average relative abundances >0.1%, present in at least 95% of tested samples.
...
rm(cOTU, OTU95, RA_001, RA, RA_full, OTU_full, ps)
```
