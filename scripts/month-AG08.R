...
pdf(file = "/home/ahalhed/red-squirrel-w2020/R-env/RedSquirrelSpatial/plots/core_AG2008_vp_mod1M.pdf")
# make plot
...
# save plot
pdf(file = "/home/ahalhed/red-squirrel-w2020/R-env/RedSquirrelSpatial/plots/core_AG2008_step_envM.pdf")
# make plot
...
# save plot
pdf(file = "/home/ahalhed/red-squirrel-w2020/R-env/RedSquirrelSpatial/plots/core_AG2008_step_spaceM.pdf")
# make plot
...
vp_mod1_list
# plot the partitioning
pdf(file = "/home/ahalhed/red-squirrel-w2020/R-env/RedSquirrelSpatial/plots/rare_AG2008_vp_mod1M.pdf")
# make plot
# plotted in numerical order by month
lapply(vp_mod1_list, plot)
dev.off()
...
# save plot
pdf(file = "/home/ahalhed/red-squirrel-w2020/R-env/RedSquirrelSpatial/plots/rare_AG2008_step_envM.pdf")
# make plot
lapply(step.env, plot)
dev.off()
...
# save plot
pdf(file = "/home/ahalhed/red-squirrel-w2020/R-env/RedSquirrelSpatial/plots/rare_AG2008_step_spaceM.pdf")
# make plot
lapply(step.space, plot)
dev.off()
...
vp_mod1_list
# plot the partitioning
pdf(file = "/home/ahalhed/red-squirrel-w2020/R-env/RedSquirrelSpatial/plots/AG2008_vp_mod1M.pdf")
# make plot
# plotted in numerical order by month
lapply(vp_mod1_list, plot)
dev.off()
...
# save plot
pdf(file = "/home/ahalhed/red-squirrel-w2020/R-env/RedSquirrelSpatial/plots/AG2008_step_envM.pdf")
# make plot
lapply(step.env, plot)
dev.off()
...
# save plot
pdf(file = "/home/ahalhed/red-squirrel-w2020/R-env/RedSquirrelSpatial/plots/AG2008_step_spaceM.pdf")
# make plot
lapply(step.space, plot)
dev.off()
