...
pdf(file = "/home/ahalhed/red-squirrel-w2020/R-env/PCNM/plots/KL2010_XY.pdf")
...
pdf(file = "/home/ahalhed/red-squirrel-w2020/R-env/PCNM/plots/KL2010_ordisurf123.pdf")
par(mfrow=c(1,3))
...
# plot
pdf(file = "/home/ahalhed/red-squirrel-w2020/R-env/PCNM/plots/KL2010_mso.pdf")
...
vp_mod1
pdf(file = "/home/ahalhed/red-squirrel-w2020/R-env/PCNM/plots/KL2010_vp_mod1.pdf")
plot(vp_mod1)
dev.off()
...
step.env$anova
# save plot
pdf(file = "/home/ahalhed/red-squirrel-w2020/R-env/PCNM/plots/KL2010_step_env.pdf")
plot(step.env)
dev.off()
...
step.space$anova
# save plot
pdf(file = "/home/ahalhed/red-squirrel-w2020/R-env/PCNM/plots/KL2010_step_space.pdf")
plot(step.space)
dev.off()
...
mod.pars <- varpart(comm_obj, ~ ., 
               ...
               transfo = "hel")
mod.pars
pdf(file = "/home/ahalhed/red-squirrel-w2020/R-env/PCNM/plots/KL2010_mod_pars.pdf")
plot(mod.pars)
dev.off()
