...
vp_mod1_list
# plot the partitioning
pdf(file = "/home/ahalhed/projects/def-cottenie/Microbiome/RedSquirrelMicrobiome/R-env/RedSquirrelMicrobiome/plots/rare_KL2010_vp_mod1M.pdf")
# make plot
# plotted in numerical order by month
lapply(vp_mod1_list, plot)
dev.off()
...
# save plot
pdf(file = "/home/ahalhed/projects/def-cottenie/Microbiome/RedSquirrelMicrobiome/R-env/RedSquirrelMicrobiome/plots/rare_KL2010_step_envM.pdf")
# make plot
lapply(step.env, plot)
dev.off()
...
# save plot
pdf(file = "/home/ahalhed/projects/def-cottenie/Microbiome/RedSquirrelMicrobiome/R-env/RedSquirrelMicrobiome/plots/rare_KL2010_step_spaceM.pdf")
# make plot
lapply(step.space, plot)
dev.off()
