...
pdf(file = "/home/ahalhed/red-squirrel-w2020/R-env/RedSquirrelSpatial/plots/AG2008_XY.pdf")
...
pdf(file = "/home/ahalhed/red-squirrel-w2020/R-env/RedSquirrelSpatial/plots/AG2008_ordisurf123.pdf")
par(mfrow=c(1,3))
...
# plot
pdf(file = "/home/ahalhed/red-squirrel-w2020/R-env/RedSquirrelSpatial/plots/AG2008_mso.pdf")
...
mso_sub3
# plot
pdf(file = "/home/ahalhed/red-squirrel-w2020/R-env/RedSquirrelSpatial/plots/AG2008_mso2.pdf")
par(mfrow=c(1,2))
...
vp_mod1
pdf(file = "/home/ahalhed/red-squirrel-w2020/R-env/RedSquirrelSpatial/plots/AG2008_vp_mod1.pdf")
plot(vp_mod1)
dev.off()
...
anova(step.env)
# save plot
pdf(file = "/home/ahalhed/red-squirrel-w2020/R-env/RedSquirrelSpatial/plots/AG2008_step_env.pdf")
plot(step.env)
dev.off()
...
anova(step.space)
# save plot
pdf(file = "/home/ahalhed/red-squirrel-w2020/R-env/RedSquirrelSpatial/plots/AG2008_step_space.pdf")
plot(step.space)
dev.off()
...
mod.pars <- varpart(comm_obj, ~ ., 
               ...
               transfo = "hel")
mod.pars
pdf(file = "/home/ahalhed/red-squirrel-w2020/R-env/RedSquirrelSpatial/plots/AG2008_mod_pars.pdf")
plot(mod.pars)
dev.off()
