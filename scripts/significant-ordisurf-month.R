...
print("Core")
print("AG 2008")
pdf(file = "/home/ahalhed/projects/def-cottenie/Microbiome/RedSquirrelMicrobiome/R-env/RedSquirrelSpatial/plots/coreM_AG2008_ordiSIG.pdf")
par(mfrow=c(1,1))
...
print("JO 2008")
pdf(file = "/home/ahalhed/projects/def-cottenie/Microbiome/RedSquirrelMicrobiome/R-env/RedSquirrelSpatial/plots/coreM_JO2008_ordiSIG.pdf")
par(mfrow=c(1,1))
ordisurf(XY_JO, scores(JO, choi=1), bubble = 4, main = "PCNM 1")
dev.off()

print("KL 2008")
pdf(file = "/home/ahalhed/projects/def-cottenie/Microbiome/RedSquirrelMicrobiome/R-env/RedSquirrelSpatial/plots/coreM_KL2008_ordiSIG.pdf")
par(mfrow=c(1,1))
...
print("Rare")
print("AG 2008")
pdf(file = "/home/ahalhed/projects/def-cottenie/Microbiome/RedSquirrelMicrobiome/R-env/RedSquirrelSpatial/plots/rareM_AG2008_ordiSIG.pdf")
par(mfrow=c(2,2))
ordisurf(XY_AG[[3]], scores(AG[[3]], choi=8), bubble = 4, main = "PCNM 8")
ordisurf(XY_AG[[3]], scores(AG[[3]], choi=7), bubble = 4, main = "PCNM 7")
ordisurf(XY_AG[[3]], scores(AG[[3]], choi=2), bubble = 4, main = "PCNM 2")
...
print("KL 2008")
pdf(file = "/home/ahalhed/projects/def-cottenie/Microbiome/RedSquirrelMicrobiome/R-env/RedSquirrelSpatial/plots/rareM_KL2008_ordiSIG.pdf")
par(mfrow=c(1,2))
ordisurf(XY_KL8[[1]], scores(KL8[[1]], choi=17), bubble = 4, main = "PCNM 17")
ordisurf(XY_KL8[[1]], scores(KL8[[1]], choi=2), bubble = 4, main = "PCNM 2")
par(mfrow=c(1,2))
...
print("KL 2009")
pdf(file = "/home/ahalhed/projects/def-cottenie/Microbiome/RedSquirrelMicrobiome/R-env/RedSquirrelSpatial/plots/rareM_KL2009_ordiSIG.pdf")
par(mfrow=c(1,2))
ordisurf(XY_KL9[[2]], scores(KL9[[2]], choi=1), bubble = 4, main = "PCNM 1")
ordisurf(XY_KL9[[2]], scores(KL9[[2]], choi=4), bubble = 4, main = "PCNM 4")
par(mfrow=c(1,1))
...
print("KL 2010")
pdf(file = "/home/ahalhed/projects/def-cottenie/Microbiome/RedSquirrelMicrobiome/R-env/RedSquirrelSpatial/plots/rareM_KL2010_ordiSIG.pdf")
par(mfrow=c(1,2))
ordisurf(XY_KL10[[1]], scores(KL10[[1]], choi=3), bubble = 4, main = "PCNM 3")
par(mfrow=c(3,3))
ordisurf(XY_KL10[[2]], scores(KL10[[2]], choi=8), bubble = 4, main = "PCNM 8")
...
print("LL 2008")
pdf(file = "/home/ahalhed/projects/def-cottenie/Microbiome/RedSquirrelMicrobiome/R-env/RedSquirrelSpatial/plots/rareM_LL2008_ordiSIG.pdf")
par(mfrow=c(2,1))
ordisurf(XY_LL[[1]], scores(LL[[1]], choi=11), bubble = 4, main = "PCNM 11")
ordisurf(XY_LL[[1]], scores(LL[[1]], choi=7), bubble = 4, main = "PCNM 7")
par(mfrow=c(1,1))
