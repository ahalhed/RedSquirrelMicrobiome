...
print("Core")
print("AG 2008")
pdf(file = "/home/ahalhed/projects/def-cottenie/Microbiome/RedSquirrelMicrobiome/R-env/RedSquirrelSpatial/plots/core_AG2008_MordiSIG.pdf")
par(mfrow=c(1,1))
...
print("JO 2008")
pdf(file = "/home/ahalhed/projects/def-cottenie/Microbiome/RedSquirrelMicrobiome/R-env/RedSquirrelSpatial/plots/core_JO2008_MordiSIG.pdf")
par(mfrow=c(1,1))
ordisurf(XY_JO, scores(JO, choi=1), bubble = 4, main = "PCNM 1")
dev.off()

print("KL 2008")
pdf(file = "/home/ahalhed/projects/def-cottenie/Microbiome/RedSquirrelMicrobiome/R-env/RedSquirrelSpatial/plots/core_KL2008_MordiSIG.pdf")
par(mfrow=c(1,1))
...
print("Full")
print("AG 2008")
pdf(file = "/home/ahalhed/projects/def-cottenie/Microbiome/RedSquirrelMicrobiome/R-env/RedSquirrelSpatial/plots/AG2008_MordiSIG.pdf")
par(mfrow=c(2,2))
...
print("KL 2008")
pdf(file = "/home/ahalhed/projects/def-cottenie/Microbiome/RedSquirrelMicrobiome/R-env/RedSquirrelSpatial/plots/KL2008_MordiSIG.pdf")
par(mfrow=c(1,2))
...
print("KL 2009")
pdf(file = "/home/ahalhed/projects/def-cottenie/Microbiome/RedSquirrelMicrobiome/R-env/RedSquirrelSpatial/plots/KL2009_MordiSIG.pdf")
par(mfrow=c(1,2))
...
print("KL 2010")
pdf(file = "/home/ahalhed/projects/def-cottenie/Microbiome/RedSquirrelMicrobiome/R-env/RedSquirrelSpatial/plots/KL2010_MordiSIG.pdf")
par(mfrow=c(1,1))
...
print("LL 2008")
pdf(file = "/home/ahalhed/projects/def-cottenie/Microbiome/RedSquirrelMicrobiome/R-env/RedSquirrelSpatial/plots/LL2008_MordiSIG.pdf")
par(mfrow=c(2,2))
...
print("Rare")
print("AG 2008")
pdf(file = "/home/ahalhed/projects/def-cottenie/Microbiome/RedSquirrelMicrobiome/R-env/RedSquirrelSpatial/plots/rare_AG2008_MordiSIG.pdf")
par(mfrow=c(2,2))
ordisurf(XY_AG[[3]], scores(AG[[3]], choi=8), bubble = 4, main = "PCNM 8")
ordisurf(XY_AG[[3]], scores(AG[[3]], choi=7), bubble = 4, main = "PCNM 7")
ordisurf(XY_AG[[3]], scores(AG[[3]], choi=2), bubble = 4, main = "PCNM 2")
...
print("KL 2008")
pdf(file = "/home/ahalhed/projects/def-cottenie/Microbiome/RedSquirrelMicrobiome/R-env/RedSquirrelSpatial/plots/rare_KL2008_MordiSIG.pdf")
par(mfrow=c(1,2))
ordisurf(XY_KL8[[1]], scores(KL8[[1]], choi=17), bubble = 4, main = "PCNM 17")
ordisurf(XY_KL8[[1]], scores(KL8[[1]], choi=2), bubble = 4, main = "PCNM 2")
par(mfrow=c(1,2))
...
print("KL 2009")
pdf(file = "/home/ahalhed/projects/def-cottenie/Microbiome/RedSquirrelMicrobiome/R-env/RedSquirrelSpatial/plots/rare_KL2009_MordiSIG.pdf")
par(mfrow=c(1,2))
ordisurf(XY_KL9[[2]], scores(KL9[[2]], choi=1), bubble = 4, main = "PCNM 1")
ordisurf(XY_KL9[[2]], scores(KL9[[2]], choi=4), bubble = 4, main = "PCNM 4")
par(mfrow=c(1,1))
...
print("KL 2010")
pdf(file = "/home/ahalhed/projects/def-cottenie/Microbiome/RedSquirrelMicrobiome/R-env/RedSquirrelSpatial/plots/rare_KL2010_MordiSIG.pdf")
par(mfrow=c(1,1))
ordisurf(XY_KL10[[1]], scores(KL10[[1]], choi=3), bubble = 4, main = "PCNM 3")
par(mfrow=c(3,4))
ordisurf(XY_KL10[[2]], scores(KL10[[2]], choi=8), bubble = 4, main = "PCNM 8")
...
print("LL 2008")
pdf(file = "/home/ahalhed/projects/def-cottenie/Microbiome/RedSquirrelMicrobiome/R-env/RedSquirrelSpatial/plots/rare_LL2008_MordiSIG.pdf")
par(mfrow=c(2,1))
ordisurf(XY_LL[[1]], scores(LL[[1]], choi=11), bubble = 4, main = "PCNM 11")
ordisurf(XY_LL[[1]], scores(LL[[1]], choi=7), bubble = 4, main = "PCNM 7")
par(mfrow=c(1,1))
