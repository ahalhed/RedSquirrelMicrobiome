...
print("AG 2008")
pdf(file = "/home/ahalhed/projects/def-cottenie/Microbiome/RedSquirrelMicrobiome/R-env/RedSquirrelSpatial/plots/rare_AG2008_ordiSIG.pdf")
par(mfrow=c(2,4))
...
print("JO 2008")
pdf(file = "/home/ahalhed/projects/def-cottenie/Microbiome/RedSquirrelMicrobiome/R-env/RedSquirrelSpatial/plots/rare_JO2008_ordiSIG.pdf")
par(mfrow=c(1,1))
ordisurf(XY_JO, scores(JO, choi=1), bubble = 4, main = "PCNM 1")
dev.off()

print("KL 2008")
pdf(file = "/home/ahalhed/projects/def-cottenie/Microbiome/RedSquirrelMicrobiome/R-env/RedSquirrelSpatial/plots/rare_KL2008_ordiSIG.pdf")
par(mfrow=c(1,1))
...
print("KL 2010")
pdf(file = "/home/ahalhed/projects/def-cottenie/Microbiome/RedSquirrelMicrobiome/R-env/RedSquirrelSpatial/plots/rare_KL2010_ordiSIG.pdf")
par(mfrow=c(2,2))
...
print("LL 2008")
pdf(file = "/home/ahalhed/projects/def-cottenie/Microbiome/RedSquirrelMicrobiome/R-env/RedSquirrelSpatial/plots/rare_LL2008_ordiSIG.pdf")
par(mfrow=c(1,2))
...
print("SU 2008")
pdf(file = "/home/ahalhed/projects/def-cottenie/Microbiome/RedSquirrelMicrobiome/R-env/RedSquirrelSpatial/plots/rare_SU2008_ordiSIG.pdf")
par(mfrow=c(1,1))
